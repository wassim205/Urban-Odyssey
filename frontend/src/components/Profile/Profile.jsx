...
import { User, Settings, Bookmark, Mail, Calendar, Heart, MapPin, Edit } from "lucide-react";
          ...
          <div className="relative px-6 pb-6">
            <div className="absolute -top-16 left-6 bg-white p-1 rounded-full shadow-lg">
              <div className="bg-gray-200 rounded-full w-32 h-32 flex items-center justify-center overflow-hidden">
                <img src="https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=mail@ashallendesign.co.uk" alt="Profile" className="w-full h-full object-cover" />
              </div>
            </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {userData.preferred_categories.map((category, index) => (
            ...
            {activeTab === "places" && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {userData.favorite_places.map((place) => (
                    <div key={place.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      <div className="h-40 bg-gray-200">
                        <img src={`/api/placeholder/400/240`} alt={place.name} className="w-full h-full object-cover" />
                      </div>
                      <div className="p-4">
                        <h4 className="font-medium text-gray-900">{place.name}</h4>
                        <p className="text-sm text-gray-500 mt-1 flex items-center gap-1">
                          <Calendar size={14} /> Visited on {new Date(place.visited).toLocaleDateString()}
                        </p>
                      </div>
                    </div>
                  ))}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <button className="mt-3 bg-blue-600 text-white px-3 py-1.5 text-sm rounded hover:bg-blue-700 transition-colors">Edit</button>
                  </div>
                  
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <h4 className="font-medium text-gray-900">Password</h4>
                    <p className="text-sm text-gray-500 mt-1">Ensure your account is using a long, random password to stay secure.</p>
                    <button className="mt-3 bg-blue-600 text-white px-3 py-1.5 text-sm rounded hover:bg-blue-700 transition-colors">Change Password</button>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <button className="mt-3 bg-blue-600 text-white px-3 py-1.5 text-sm rounded hover:bg-blue-700 transition-colors">Update</button>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <button className="mt-3 bg-red-600 text-white px-3 py-1.5 text-sm rounded hover:bg-red-700 transition-colors">Delete Account</button>
                  </div>
                </div>
              </div>
            )}
