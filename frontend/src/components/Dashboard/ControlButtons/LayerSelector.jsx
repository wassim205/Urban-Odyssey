...
function LayerSelector({ isOpen, onLayerChange, onClose, currentLayer }) {
  ...
  return (
    <div 
      ref={selectorRef}
      className="fixed top-16 left-4 sm:absolute sm:top-8 sm:left-0 sm:mt-16 sm:ml-4 bg-white shadow-lg rounded-lg z-[1000] w-[calc(100%-32px)] sm:w-72 flex flex-col max-h-[80vh] transition-all duration-300 ease-in-out touch-none"
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-0 hover:opacity-100 transition-opacity">
                <span className="bg-[#D8C292] text-white px-3 py-1 rounded-full text-sm">
                  Preview
                </span>
              </div>
            </div>
