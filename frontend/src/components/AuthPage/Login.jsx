        ...
        >
          ...
          <div className="bg-[#D8C292] w-full rounded-b-[1.438rem] drop-shadow-lg p-8">
            <form
              ...
              className="space-y-4 font-Belgrano text-[#A45A3D]"
            >
              <InputField
                label="Email"
                type="email"
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                >
                  <img src={googleIcon} alt="Google" className="mr-2 w-6 h-6" />
                  Log in with Google
                </motion.button>
              ...
              <div className="text-center px-22 flex flex-col items-center">
                ...
                <p className="text-[#313131] font-montserrat text-base font-medium text-center">
                  Every hidden alley and vibrant avenue holds a story waiting to
                  be told—an urban heartbeat whispering secrets of untold
                  journeys. Let's explore together and uncover the magic of
                  every step.
                </p>
              </div>
            </form>
